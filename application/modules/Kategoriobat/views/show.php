...
$menusid = $this->M_crud->get_by_param("menu", 'name', "Merk");
if(!empty($menusid)){
    			...
    			<div class="box box-primary box-solid">
					<div class="box-header with-border">
					  <h3 class="box-title">Data Kategori</h3>
						...
						<div class="box-body">
							  <a href="<?php echo site_url('Kategoriobat/cetak');?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Cetak</a>
			              	  <a href="<?php echo site_url('Kategoriobat/doexport');?>" style="margin-right: 10px;" target="_blank" class="btn btn-success pull-right">
			              		<i class="fa fa-file-excel-o"></i> Export Excell</a>
							  <?php if($this->session->userdata['simklinik']['ap_is_admin'] == 1 || $mnCreate == 1){
			              	  ?>
			              	  <a href="<?php echo base_url(); ?>Kategoriobat/add_kategoriobat" style="margin-right: 10px;" class="btn btn-primary pull-right">
						  ...
						  <table id="example2" class="table table-bordered table-striped">
							...
							<?php
								...
								{
							?>
									<a class="btn btn-warning btn-xs" href="<?php echo site_url('Kategoriobat/edit\/').$data->id_kategori;?>">
							...
							?>
									<a class="btn btn-danger btn-xs" title="Hapus" href="" data-toggle="modal"
										onclick="confirm_delete('<?php echo site_url('Kategoriobat/delete').'/'.$data->id_kategori;?>',
										'<?php echo $data->nama_kategori;?>');"><i class="fa fa-trash"></i></a>
							<?php
								}
							?>
