<?php
		$menusid = $this->M_crud->get_by_param("menu", 'name', "Paket");
		if(!empty($menusid)){
	          ...
	          ?>
				...
				<div class="col-md-12">
					<div class="box box-widget">
						...
						<div class="box-body">
								<a href="<?php echo site_url('Paket/cetak');?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Cetak</a>
				              	<a href="<?php echo site_url('Paket/doexport');?>" style="margin-right: 10px;" target="_blank" class="btn btn-success pull-right">
				              		<i class="fa fa-file-excel-o"></i> Export Excell</a>
							  <?php if($this->session->userdata['simklinik']['ap_is_admin'] == 1 || $mnCreate == 1){
			              	  ?>
			              	  <a href="<?php echo base_url(); ?>Paket/tambah" style="margin-right: 10px;" class="btn btn-primary pull-right">
                  ...
                  <?php foreach($pakets as $key => $paket){
										$tarif = $this->M_base->currFormat2($paket->total_harga);
                    ...
                    <tr>
                      ...
                      <td>
                      	<?php
							...
							{
						?>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url('Paket/edit\/').$paket->paket_layanan_id;?>">
						...
						?>
								...
								onclick="confirm_delete('<?php echo site_url('Paket/hapus').'/'.$paket->paket_layanan_id;?>',
								'<?php echo $paket->nama_paket_layanan;?>');"><i class="fa fa-trash"></i></a>
						<?php
							}
						?>
                      </td>
