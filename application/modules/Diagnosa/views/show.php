...
$menusid = $this->M_crud->get_by_param("menu", 'name', "ICD");
if(!empty($menusid)){
    		...
    		<section class="content">
    			...
    			<div class="box box-widget">
					<div class="box-header with-border">
					  <h3 class="box-title">Data ICD</h3>
					</div>
						<div class="box-body">
								<a href="<?php echo site_url('Diagnosa/cetak');?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Cetak</a>
			              		<a href="<?php echo site_url('Diagnosa/doexport');?>" style="margin-right: 10px;" target="_blank" class="btn btn-success pull-right">
			              		<i class="fa fa-file-excel-o"></i> Export Excell</a>
							  <?php if($this->session->userdata['simklinik']['ap_is_admin'] == 1 || $mnCreate == 1){
			              	  ?>
			              	  <a href="<?php echo base_url(); ?>Diagnosa/add_diagnosa" style="margin-right: 10px;" class="btn btn-primary pull-right">
						  ...
						  <table id="example2" class="table table-bordered table-striped">
							...
							<?php
								...
								{
							?>
									<a class="btn btn-warning btn-xs" href="<?php echo site_url('Diagnosa/edit\/').$data->id_diagnosa;?>">
							...
							?>
									<a class="btn btn-danger btn-xs" title="Hapus" href="" data-toggle="modal" 
										onclick="confirm_delete('<?php echo site_url('Diagnosa/delete').'/'.$data->id_diagnosa;?>',
										'<?php echo $data->kode_icd;?>');"><i class="fa fa-trash"></i></a>
							<?php
								}
							?>
