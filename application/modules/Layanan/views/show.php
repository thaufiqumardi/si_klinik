    			...
    			<div class="box box-primary box-solid">
					<div class="box-header with-border">
					  <h3 class="box-title">Data Layanan</h3>
						...
						<div class="box-body">
							  <a href="<?php echo site_url('Layanan/cetak');?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Cetak</a>
				              	<a href="<?php echo site_url('Layanan/doexport');?>" style="margin-right: 10px;" target="_blank" class="btn btn-success pull-right">
				              		<i class="fa fa-file-excel-o"></i> Export Excell</a>
							  <?php if($this->session->userdata['simklinik']['ap_is_admin'] == 1 || $mnCreate == 1){
			              	  ?>
			              	  <a href="<?php echo base_url(); ?>Layanan/add_layanan" style="margin-right: 10px;" class="btn btn-primary pull-right">
						  ...
						  <table id="example2" class="table table-bordered table-striped">
							...
							<tr>
							  ...
							  <th class="text-center">Tarif Normal</th>
							  <th class="text-center">Tarif Khusus</th>
							...
							<?php
								if($layanan > 0)
								{
									...
									foreach($layanan as $data)
									{
										...
										$tarif = $this->M_base->currFormat2($data->tarif_layanan);
										// $tarif = str_replace(".00", "", $tarif);
										$tarif = substr($tarif,0,-3);
										$tarif = "Rp. ".$tarif;

										$tarif_khusus = "";
										if(!empty($data->tarif_khusus)){
											$tarif_khusus = $this->M_base->currFormat2($data->tarif_khusus);
											// $tarif_khusus = str_replace(".00", "", $tarif_khusus);
											$tarif_khusus = substr($tarif_khusus,0,-3);
							...
							<?php
								...
								{
							?>
									<a class="btn btn-warning btn-xs" href="<?php echo site_url('Layanan/edit\/').$data->id_layanan;?>">
							...
							?>
									...
									onclick="confirm_delete('<?php echo site_url('Layanan/delete').'/'.$data->id_layanan;?>',
									'<?php echo $data->nama_layanan;?>');"><i class="fa fa-trash"></i></a>
							<?php
								}
							?>
