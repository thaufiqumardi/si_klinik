...
$menusid = $this->M_crud->get_by_param("menu", 'name', "LaporanJurnalPengeluaran");
if(!empty($menusid)){
...
<html>
    		...
    		<section class="content">
    			...
    			<div class="box box-widget">
					<div class="box-header with-border">
					  <h3 class="box-title">Laporan Jurnal Pengeluaran</h3>
					</div>					
					<div class="box-body">
						<br>
						<form id="formAct" action="<?php echo base_url('Keuangan/cetak_laporanjurnalpengeluaran'); ?>" method="post" class="form-horizontal form-label-left">
							<div class="form-group">
								...
								<div class="col-lg-1">
									<a href="<?php echo base_url('Keuangan/jurnalpengeluaran'); ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> Reset</a>
								</div>
							</div>					
							<div class="pull-left">
    ...
    $(document).ready(function() {
    	...
    	$('#mnLaporanJurnalPengeluaran').addClass('active');
