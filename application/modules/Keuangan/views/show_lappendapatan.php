...
$menusid = $this->M_crud->get_by_param("menu", 'name', "LaporanPendapatan");
if(!empty($menusid)){
...
<html>
    	...
    	<div class="content-wrapper">
    		<section class="content">
    			...
    			<div class="box box-widget">
					...
					<div class="box-body">
						<br>
						<form id="formAct" action="<?php echo base_url('Keuangan/cetak_laporanpendapatan'); ?>" method="post" class="form-horizontal form-label-left" onsubmit="return validate()">
							<div class="form-group">
								...
								<div class="col-lg-1">
									<a href="<?php echo base_url('Keuangan/laporanpendapatan'); ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> Reset</a>
								</div>
							</div>							
							<div class="pull-left">
							...
							<thead>
						  	...
						  	<tbody>
						  		...
						  		<?php foreach($details as $key){ ?>
						  		  <tr>
						  		  	<?php if($key->no_kuitansi !== $nopendaftaran) { $nopendaftaran = ""; }?>
						 			...
						 			<td style="border: 1px solid #e3e3e3; text-align:center;"></td>
						  			...
						  			<td style="border: 1px solid #e3e3e3; text-align:left; padding-left:5px;"></td>
						 			<?php } ?>
						 			<?php $nopendaftaran = $key->no_kuitansi; ?>
    ...
    $(document).ready(function() {
    	...
    	$('#mnLaporanPendapatan').addClass('active');
