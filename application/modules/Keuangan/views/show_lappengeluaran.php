...
$menusid = $this->M_crud->get_by_param("menu", 'name', "LaporanPengeluaran");
if(!empty($menusid)){
...
<html>
    	...
    	<div class="content-wrapper">
    		<section class="content">
    			...
    			<div class="box box-widget">
					...
					<div class="box-body">
						<br>
						<form id="formAct" action="<?php echo base_url('Keuangan/cetak_laporanpengeluaran'); ?>" method="post" class="form-horizontal form-label-left" onsubmit="return validate()">
							<div class="form-group">
								...
								<div class="col-lg-1">
									<a href="<?php echo base_url('Keuangan/laporanpengeluaran'); ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> Reset</a>
								</div>
							</div>						
							<div class="pull-left">
    ...
    $(document).ready(function() {
    	...
    	$('#mnLaporanPengeluaran').addClass('active');
