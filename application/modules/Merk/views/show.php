    			...
    			<div class="box box-primary box-solid">
					<div class="box-header with-border">
					  <h3 class="box-title">Data Merk</h3>
						...
						<div class="box-body">
							 <a href="<?php echo site_url('Merk/cetak');?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Cetak</a>
			              	 <a href="<?php echo site_url('Merk/doexport');?>" style="margin-right: 10px;" target="_blank" class="btn btn-success pull-right">
			              		<i class="fa fa-file-excel-o"></i> Export Excell</a>
							  <?php if($this->session->userdata['simklinik']['ap_is_admin'] == 1 || $mnCreate == 1){
			              	  ?>
			              	  <a href="<?php echo base_url(); ?>Merk/add_merk" style="margin-right: 10px;" class="btn btn-primary pull-right">
						  ...
						  <table id="example2" class="table table-bordered table-striped">
							...
							<?php
								...
								{
							?>
									<a class="btn btn-warning btn-xs" href="<?php echo site_url('Merk/edit\/').$data->merk_id;?>">
							...
							?>
									<a class="btn btn-danger btn-xs" title="Hapus" href="" data-toggle="modal"
										onclick="confirm_delete('<?php echo site_url('Merk/delete').'/'.$data->merk_id;?>',
										'<?php echo $data->merk_nama;?>');"><i class="fa fa-trash"></i></a>
							<?php
								}
							?>
